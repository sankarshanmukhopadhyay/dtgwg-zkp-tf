...
- **Scenarios (constrains):** [`UC-008`](../reference/identifier-register.md#uc-008), [`UC-016`](../reference/identifier-register.md#uc-016) — see `matrices/adr-scenario-map.csv`.
- **Scenario (informs):** [`UC-020`](../reference/identifier-register.md#uc-020), where whether the issuer of an
  accessibility-alternative attestation must be visible interacts directly
  with non-discrimination requirements.
- **Scenario (validated-by):** [`UC-024`](../reference/identifier-register.md#uc-024), where issuer concealment is one of
...
- **Negative conformance test:** `CT-UC024-POS-02`/`CT-UC024-NEG-02`
  ...
  `../conformance/test-matrix.csv`. [`UC-008`](../reference/identifier-register.md#uc-008) and [`UC-016`](../reference/identifier-register.md#uc-016) are P1 and not yet
