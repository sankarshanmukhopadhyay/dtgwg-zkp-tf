...
| | |
|---|---|
| Predicates | reuses [`CL-1`](../reference/identifier-register.md#cl-1)'s [`PR-LIV`](../reference/identifier-register.md#pr-liv), [`PR-HLD`](../reference/identifier-register.md#pr-hld), [`PR-FRE`](../reference/identifier-register.md#pr-fre) |
...
evidence" or "agent key binding," both of which [`UC-009`](../reference/identifier-register.md#uc-009), [`UC-010`](../reference/identifier-register.md#uc-010) and [`UC-011`](../reference/identifier-register.md#uc-011)
require. [`CL-3`](../reference/identifier-register.md#cl-3) test cases reference these informally pending a taxonomy
update (tracked in `matrices/maturity-map.csv`). Implementers should not
read the absence of a [`PR-DEL`](../reference/identifier-register.md#pr-del) identifier as meaning delegation is
unconstrained — see [`ADR-001`](../reference/identifier-register.md#adr-001).
...
| | |
|---|---|
| Predicates | adds [`PR-ISS`](../reference/identifier-register.md#pr-iss); reuses [`PR-LIV`](../reference/identifier-register.md#pr-liv), [`PR-HLD`](../reference/identifier-register.md#pr-hld), [`PR-FRE`](../reference/identifier-register.md#pr-fre), [`PR-UNQ`](../reference/identifier-register.md#pr-unq), [`PR-PER`](../reference/identifier-register.md#pr-per) from lower levels where the scenario requires them |
